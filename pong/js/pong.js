...
Sprite.prototype.startAnimation = function (fct, interval) {
    console.log ("fonctin startAnimation");
...
Sprite.prototype.stopAnimation = function () {
    console.log ("fonction stopAnimation");
    window.clearInterval(this._clock);
};

Sprite.prototype.checkCollision = function (other) {
    console.log ("fonction checkCollison");
    // console.log ("This.top = " + this.top);
    // console.log ("This.left = " + this.left);
    // console.log ("other.top = " + other.top);
    // console.log ("other.left = " + other.left);
    return ((this.top < (other.top + other.vais.height) && (this.top + this.vais.height) > other.top) 
        && (this.left < (other.left + other.vais.width) && (this.left + this.vais.width) > other.left))    
};